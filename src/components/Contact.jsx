                ...
                >
                    ...
                    <div className="flex flex-col items-center gap-8 mb-12">
                        ...
                        <div className="flex flex-col sm:flex-row justify-center gap-4 w-full sm:w-auto">
                            <a 
                                href="tel:9944362457" 
                                className="group flex items-center justify-center gap-3 bg-white text-gray-800 border border-gray-100 px-8 py-4 rounded-full font-bold hover:scale-105 transition-all text-base sm:text-lg shadow-md w-full sm:w-auto"
                            >
                            ...
                            <a 
                                ...
                                className="group flex items-center justify-center gap-3 bg-gradient-to-r from-pink-400 to-blue-400 text-white px-8 py-4 rounded-full font-bold hover:scale-105 transition-all text-base sm:text-lg shadow-md w-full sm:w-auto"
                            >
                    ...
                    {/* WhatsApp Footer */}
                    <div className="p-6 sm:p-8 rounded-2xl bg-gray-50 border border-gray-100 space-y-4">
                        <p className="text-gray-500 text-sm sm:text-base italic leading-relaxed">
                        ...
                        <a 
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="inline-flex items-center gap-3 text-lg sm:text-xl font-bold text-pink-400 hover:text-pink-600 transition-colors group"
                        >
